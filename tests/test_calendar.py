"""Tests for the CTT deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.ctt.calendar import CTTDeliveriesCalendar
...
def _cal(data):
    return CTTDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="CTT Shop")])
    assert cal._events()[0].location == "CTT Shop"
